...
public sealed class Configuration : IPluginConfiguration
{
    ...
    public string CloudApiBaseUrl = "https://privatelist-api.kkevinbhrain.workers.dev";
    ...
    public string CloudProfileThemeName = "Default";
    public string CloudProfileThemeColorHex = "#2BE5B5";
    public string CloudProfileDisplayNameEffect = "None";
    public string CloudProfileBannerUrl = string.Empty;
    public string CloudProfileBannerLocalPath = string.Empty;
    public string CloudProfileAvatarBorderColorHex = "#2BE5B5";
    public string CloudProfileAvatarPlaceholderStyle = "Question Mark";
    public string ProfileStatusVisibility = "All";
    public string ProfileVenuesVisibility = "All";
    public string ProfileLocationVisibility = "All";
    public string ProfileBioVisibility = "All";
    public bool AutoStatusByActivity = false;
    public bool AutoStatusHideLocationInDuty = true;
    public string OpenMainWindowShortcut = "Ctrl+P";
    public string OpenTargetProfileShortcut = "Ctrl+Shift+P";
    public string OpenTargetNotesShortcut = "Ctrl+N";
